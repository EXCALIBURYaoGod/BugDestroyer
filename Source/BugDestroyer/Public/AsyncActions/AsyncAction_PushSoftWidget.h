...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPushSoftWidgetDelegate, UWidget_ActivatableBase*, InPushWidget);

UCLASS()
class BUGDESTROYER_API UAsyncAction_PushSoftWidget : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UAsyncAction_PushSoftWidget* PushSoftWidget(
		...
		UPARAM(meta = (Categories = "Bug.WidgetStack")) FGameplayTag InWidgetStackTag,
